 ...
 */
#define PLAYER_NAME HomelanderV5
            ...
            for(Dir d : dirs) {
                if(pos_ok(i.p+d)) {
                    if(not m[(i.p+d).i][(i.p+d).j]) {
                        ...
                        else if(cell(i.p+d).type != Building and cell(i.p+d).id == -1 and (cell(i.p+d).b_owner == me() or cell(i.p+d).b_owner == -1)) {
                            str j; j.p = i.p+d, j.dist = i.dist+1; j.firstMove = new Dir;
                            if(i.firstMove == NULL)
                                *j.firstMove = d;
                            else 
            ...
            for(Dir d : dirs) {
                if(pos_ok(i.p+d)) {
                    if(not m[(i.p+d).i][(i.p+d).j]) {
                        ...
                        if((isThereAnEnemy(i.p+d,Builder) and ((cell(i.p+d).b_owner!=-1 and citizen(id).weapon==Bazooka) or cell(i.p+d).b_owner==-1)) or (isThereAnEnemy(i.p+d,Warrior) and not hasBetterWeapon(citizen(id).weapon,citizen(cell(i.p+d).id).weapon))) {
                            if(i.firstMove == NULL)
                                firstMoveReturn = d;
                            else
                                firstMoveReturn = *i.firstMove;
        ...
        while(not q.empty()) {
            ...
            for(Dir d : dirs) {
                if(pos_ok(i.p+d)) {
                    if(not m[(i.p+d).i][(i.p+d).j]) {
                        int enemyId = cell(i.p+d).id;
                        if(isThereAnEnemy(i.p+d, Builder) and ((cell(i.p+d).b_owner!=-1 and citizen(id).weapon==Bazooka) or cell(i.p+d).b_owner==-1)) {
                            if(i.firstMove == NULL)
                                firstMoveReturn = d;
                            else
                                firstMoveReturn = *i.firstMove;
                        ...
                        else if(cell(i.p+d).type != Building and (cell(i.p+d).b_owner == -1 or cell(i.p+d).b_owner==me()) and cell(i.p+d).id == -1) {
                            str j; j.p = i.p+d, j.dist = i.dist+1; j.firstMove = new Dir;
                            if(i.firstMove == NULL)
                                *j.firstMove = d;
                            else 
            ...
            for(int id : b) {
                ...
                if(citizen(id).life > 0) {
                    if(cell(a).b_owner==me()) {
                        ...
                        if(cell(a).resistance < barricade_max_resistance()/3) {
